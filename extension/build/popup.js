...
(function() {
  ...
  window.WLC = function($root) {
    WLC.router = new WLC.Router({
      el: $root.find('#page')
    });
  ...
  WLC.navigate = function(path) {
    return Backbone.history.navigate(path, {
      trigger: true
    });
  };

  WLC.hardNavigate = function(path) {
  ...
  WLC.captureForms = function($el) {
    return $el.on("submit", "form", function(evt) {
      var action;
  ...
  WLC.Analytics = {
    ...
    trackPage: function() {
      return this.track(['_trackPageview', Backbone.history.fragment]);
    },
    trackLoad: function(t0) {
      return this.track(['_trackTiming', 'chrome-extension', 'page load', new Date() - t0, 'ready', 100]);
    }
  };

  WLC.errorHandler = function(event) {
    $('body').addClass('js-error');
    return WLC.Analytics.track(['_trackEvent', 'chrome-extension', 'js-error', document.location.toString()]);
  };
...
(function() {
  ...
  WLC.Router = (function(_super) {
    ...
    Router.prototype.initialize = function(options) {
      var _this = this;
      this.$el = options.el;
      return _(WLC.Routes).each(function(v, k) {
        return _this.route(v, k);
      });
    };

    Router.prototype.compass = function() {
    ...
    Router.prototype.noRoute = function() {
      ...
      if (fragment !== fragment.toLowerCase()) {
        return WLC.navigate('/' + fragment.toLowerCase());
      } else if (/\/$/.test(fragment)) {
        return WLC.navigate('/' + fragment.slice(0, -1));
      } else {
        return this.launch(WLC.Views.NoRoute);
      }
    };

    Router.prototype.launch = function(viewKlass, options) {
      var done, t0, view,
        _this = this;
      ...
      WLC.view = view;
        ...
        _this.render(view);
        return WLC.Analytics.trackLoad(t0);
      };
      if (view.ready) {
        view.ready.done(done);
        return view.ready.fail(function(xhr) {
          WLC.Analytics.trackLoad(t0);
          if (xhr && (xhr.status === 401 || xhr.status === 403)) {
            return WLC.navigate(WLC.Paths.login({
              returnUrl: '/' + Backbone.history.fragment
            }));
          } else {
            return WLC.errorHandler();
          }
        });
      } else {
        return done();
...
(function() {
  ...
  WLC.Views.Compass = (function(_super) {
    ...
    Compass.prototype.mittens = function() {
      return ['becky', 'kyle'];
    };
...
(function() {
  ...
  WLC.Views.NoRoute = (function(_super) {

    __extends(NoRoute, _super);

    function NoRoute() {
      return NoRoute.__super__.constructor.apply(this, arguments);
    }

    NoRoute.prototype.render = function() {
      this.$el.html("<h1>Nothing matches that route!</h1>");
      return this;
    };
